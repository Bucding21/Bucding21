...
<div id="ctitle" style="display:none;">     ❤❤            ❤❤
 ❤❤❤❤  ❤❤❤❤
❤❤❤❤❤❤❤❤❤
❤❤accct.cn/yeuhongnhan❤❤
     ❤❤❤❤❤❤❤
          ❤❤❤❤❤
               ❤❤❤
                    ❤</div>
                    
<audio id="audio_music" src="nhann.mp4" loop="loop"></audio>
...
<script>
    ...
    var temp_id = "29";
    var views = "1396";
    var dataInfo = {"id":1044,"nid":1044,"title":"\u2764\ufe0f\ufe0f\ufe0f","ftitle":"\u8fd9\u4e2a\u7231\u7684\u5f62\u72b6\r\n\u4ee3\u8868\u7740\u6211\u4eec\uff1a\r\n\u90fd\u4e00\u5b9a\u4f1a\u5e78\u798f\uff01","ctitle":"","temp_id":29,"background_url":"https:\/\/p3-search.byteimg.com\/obj\/labis\/3498727a4b2892b982b3085651630b1b","opacity":1,"music_url":"https:\/\/txmov2.a.kwimgs.com\/upic\/2022\/06\/15\/14\/BMjAyMjA2MTUxNDM5MjdfNDI1MTA0MDAxXzc2ODI0ODg2NzQyXzFfMw==_b_B0bde14eb4843f344b712d8d53c2c95ba.mp4","data_type":0,"vip":0,"views":1396,"views_update":false};
    ...
    function printText() {
    	...
    	let timer = setInterval(() => {
    		if (str_.length < str.length) {
    			str_ += str[i++];
    			content.innerHTML = '<p>' + str_ + '<span style="opacity: 1;color: red;">❤️</span></p>';
    		} else {
    			clearInterval(timer);
	...
	if (ua.indexOf("miniprogram") < 1 && temp_id != "25"){
	    ...
	    htmlobj.addEventListener('click', function(){
            if(!is_copy){
                ...
                btns.length > 1 ? btns[1].style.display = "block" : '';
            }
        });
	}
